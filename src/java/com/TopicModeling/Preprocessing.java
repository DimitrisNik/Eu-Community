...
public class Preprocessing {
     ...
     */
    private String createProcess(Input in) throws OtherException {
...
//end process
    ...
    private void safeProcess(String xml) throws Exception {
        ...
        File file = new File(path + "\\preproccesing_TopicModeling.rmp");
     ...
     */
    public ArrayList<String> run(Input in) throws Exception {
        ArrayList<String> nlpPost = new ArrayList<>(); //list of post after preprocessing
        String rmprocess = createProcess(in);
        safeProcess(rmprocess);

        RapidminerProccess rm = new RapidminerProccess(path + "\\preproccesing_TopicModeling.rmp");
